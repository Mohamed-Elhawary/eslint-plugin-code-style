...
**eslint-plugin-code-style** is an ESLint plugin providing 80 custom formatting rules (70 auto-fixable, 19 configurable, 10 report-only) for React/JSX projects. It's designed for ESLint v9+ flat config system.
...
**TypeScript-only rules** (71 rules in JS projects, 80 in TS projects):
...
- **Hook Rules** — React hooks formatting
  - `hook-callback-format`, `hook-deps-per-line`, `hook-file-naming-convention`
...
- Currently: 70 auto-fixable rules, 19 configurable rules, 10 report-only rules
...
|------|---------|----------------|
| `README.md` | ~22 | `*80 rules (70 auto-fixable, 19 configurable)*` |
| `README.md` | ~30 | `**80 custom rules** (70 auto-fixable, 19 configurable)` |
| `README.md` | ~39 | `70 of 80 rules support auto-fix` |
| `README.md` | ~100 | `**70 rules** support automatic fixing... **19 rules** have configurable options. 10 rules are report-only` |
| `README.md` | ~272 | `**80 rules total** — 70 with auto-fix, 19 configurable` |
| `README.md` | ~409 | `70 of 80 rules support auto-fixing` |
| `docs/rules/README.md` | ~3 | `**80 rules total** — 70 with auto-fix, 19 configurable` |
| `AGENTS.md` | ~7 | `80 custom formatting rules (70 auto-fixable, 19 configurable, 10 report-only)` |
| `AGENTS.md` | ~37 | `(71 rules in JS projects, 80 in TS projects)` |
| `AGENTS.md` | ~675 | `all 80 rules` |
| `AGENTS.md` | ~733 | `70 auto-fixable rules, 19 configurable rules, 10 report-only` |
| `AGENTS.md` | Rule Count Locations section | Current Counts table |
| `recommended-configs/react/README.md` | ~286 | `**70 auto-fixable rules** (80 total, 19 configurable, 10 report-only)` |
| `recommended-configs/react-ts/README.md` | ~361 | `**70 auto-fixable rules** (80 total, 19 configurable, 10 report-only)` |
| `recommended-configs/react-tw/README.md` | ~321 | `**70 auto-fixable rules** (71 JavaScript-compatible rules out of 80 total)` |
| `recommended-configs/react-ts-tw/README.md` | ~396 | `**70 auto-fixable rules** (80 total, 19 configurable, 10 report-only)` |
...
- **Current releases:** v2.1.0, v2.0.0, v1.20.0, v1.19.0, v1.18.0, v1.17.0, v1.16.0, v1.15.0, v1.14.0, v1.13.0, v1.12.0, v1.11.0, v1.10.0, v1.9.0, v1.8.0, v1.7.0, v1.6.0, v1.5.0, v1.4.2, v1.3.0, v1.2.0, v1.1.0, v1.0.16, v1.0.14, v1.0.7, v1.0.6
