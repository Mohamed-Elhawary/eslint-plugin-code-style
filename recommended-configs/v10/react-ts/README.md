# ESLint v10 — React + TypeScript Configuration

> **This configuration is for ESLint v10.** Requires ESLint `>= 10.0.0` and Node.js `^20.19.0 || ^22.13.0 || >=24`. For ESLint v9, see the [v9 configuration](../../v9/react-ts/).

Recommended ESLint configuration for React + TypeScript projects using **ESLint v10**.
