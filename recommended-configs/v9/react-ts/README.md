# Recommended ESLint Configuration for React + TypeScript Projects

> **This configuration is for ESLint v9.** Requires ESLint `>= 9.0.0` and `< 10.0.0`. For ESLint v10, see the [v10 configuration](../../v10/react-ts/).

This is the **recommended ESLint flat configuration** for React projects using TypeScript (without Tailwind CSS). This configuration provides the ultimate code style consistency by combining:
...
Our custom plugin provides **71 auto-fixable rules** (81 total, 20 configurable, 10 report-only) that fill the gaps not covered by ESLint's built-in rules or other plugins.
...
| Feature | React Config | React + TS Config | React + TS + TW Config |
|---------|-------------|-------------------|------------------------|
| TypeScript Parser | ❌ | ✅ | ✅ |
| TypeScript Rules | ❌ | ✅ | ✅ |
| Tailwind Rules | ❌ | ❌ | ✅ |
| Interface Sorting | ❌ | ✅ | ✅ |
| File Extensions | `.js`, `.jsx` | `.js`, `.jsx`, `.ts`, `.tsx` | `.js`, `.jsx`, `.ts`, `.tsx` |
